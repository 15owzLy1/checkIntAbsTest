...
define i8* @task_measure(i8* %unused) #0 {
  ...
  store i32 0, i32* @tickCounter, align 4
  %5 = load i32, i32* @intervalCounter, align 4
  %6 = add nsw i32 %5, 1
  store i32 %6, i32* @intervalCounter, align 4
  store i32 1, i32* @records, align 4
  %7 = load i32, i32* @numberOfRecords, align 4
  %8 = add nsw i32 %7, 1
  store i32 %8, i32* @numberOfRecords, align 4
  ret i8* undef
}
...
define i32 @main() #0 {
  ...
  store i32 0, i32* @systemState, align 4
  %1 = call i32 @pthread_create(i64* %t1, %union.pthread_attr_t* null, i8* (i8*)* @task_communicate, i8* null) #3
  %2 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @task_measure, i8* null) #3
  ret i32 0
}
