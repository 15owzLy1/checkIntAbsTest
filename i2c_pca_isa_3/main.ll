...
define i8* @req6(i8* %unused) #0 {
  ...
  %1 = load i32, i32* @cnt6, align 4
  %2 = add nsw i32 %1, 1
  store i32 %2, i32* @cnt6, align 4
  ret i8* undef
}
...
define i32 @main() #0 {
  ...
  %7 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @req7, i8* null) #4
  %8 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @req8, i8* null) #4
  ret i32 0
}
