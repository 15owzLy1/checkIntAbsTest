...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %2 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @closer1, i8* null) #5
  %3 = call i32 @pthread_create(i64* %t2, %union.pthread_attr_t* null, i8* (i8*)* @closer2, i8* null) #5
